...
// MARK: Public UIX3ToolTipDelegate
@objc public protocol UIX3ToolTipDelegate: AnyObject {
...
open class UIX3ToolTip: UIView {
    ...
    private weak var delegate: UIX3ToolTipDelegate?
    ...
    init(view: UIView, identifier: String, title: String? = nil, message: String, button: String? = nil, arrowPosition: ArrowPosition, preferences: ToolTipPreferences, delegate: UIX3ToolTipDelegate? = nil) {
    ...
    fileprivate func calculateFrame() {
        let refViewFrame: CGRect = presentingView.convert(presentingView.bounds, to: UIApplication.keyWindow);
    ...
    private func drawBackgroundLayer() {
        if let view = self.containerWindow?.rootViewController?.view {
            let refViewFrame = presentingView.convert(presentingView.bounds, to: UIApplication.keyWindow);
...
// MARK: Public methods *UIView* extensions
public extension UIView {
    @objc func showToolTip(identifier: String, title: String? = nil, message: String, button: String? = nil, arrowPosition: UIX3ToolTip.ArrowPosition, preferences: ToolTipPreferences = ToolTipPreferences(), delegate: UIX3ToolTipDelegate? = nil) {
        let tooltip = UIX3ToolTip(view: self, identifier: identifier, title: title, message: message, button: button, arrowPosition: arrowPosition, preferences: preferences, delegate: delegate)
        tooltip.calculateFrame()
        tooltip.show()
    }
}
// MARK: Public methods *UIBarItem* extensions
